...
let cliente1: Cliente = new Cliente("Ezequiel", "Villalba", 40123912, "Av.Alem 123", ["Juan", "Enzo", "Autor2", "Autor3"], ["Drama", "Crimen", "Policial"], 0.15);
let cliente2: Cliente = new Cliente("Camila", "Vazquez", 31912100, "Olavarria 123", ["Marta", "Gonzalo","Autor1"], ["Romantica", "Poema"], 0.15);
let cliente3: Cliente = new Cliente("Antonela", "Farias", 42128112, "Rosas 123", ["Florencia", "Enzo", "Juan","Autor2", "Autor3"], ["Terror", "Crimen", "Policial"], 0.3);
let cliente4: Cliente = new Cliente("Leonardo", "Lopez", 42128112, "Belgrano 123", ["Paula", "Marta", "Gonzalo", "Pedro", "Autor1"], ["Drama", "Comedia", "Romantica"], 0.1);
let cliente5: Cliente = new Cliente("Joaquin", "Echeverri", 44012312, "Santa Cruz 123", ["Autor2", "Autor3", "Paula"], ["Comedia", "Terror"], 0.30 )
...
const libreria: Libreria = new Libreria(libros, revistas);
