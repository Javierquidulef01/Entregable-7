...
let cliente1 = new Cliente_1.Cliente("Ezequiel", "Villalba", 40123912, "Av.Alem 123", ["Juan", "Enzo", "Autor2", "Autor3"], ["Drama", "Crimen", "Policial"], [lib1, lib5], 0.15);
let cliente2 = new Cliente_1.Cliente("Camila", "Vazquez", 31912100, "Olavarria 123", ["Marta", "Gonzalo", "Autor1"], ["Romantica", "Poema"], [lib3, lib4], 0.15);
let cliente3 = new Cliente_1.Cliente("Antonela", "Farias", 42128112, "Rosas 123", ["Florencia", "Enzo", "Juan", "Autor2", "Autor3"], ["Terror", "Crimen", "Policial"], [lib1, lib6, lib7, lib5], 0.3);
let cliente4 = new Cliente_1.Cliente("Leonardo", "Lopez", 42128112, "Belgrano 123", ["Paula", "Marta", "Gonzalo", "Pedro", "Autor1"], ["Drama", "Comedia", "Romantica"], [lib8, rev1], 0.1);
let cliente5 = new Cliente_1.Cliente("Joaquin", "Echeverri", 44012312, "Santa Cruz 123", ["Autor2", "Autor3", "Paula"], ["Comedia", "Terror"], [rev2, rev4, lib8, lib1], 0.30);
...
const libreria = new Libreria_1.Libreria(libros, revistas, clientes);
